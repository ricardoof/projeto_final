...
class Games : public Products
{
	...
	// Constructor
	public:
	Games(std::string name, std::string studio, std::string ageRating, float price, std::string availability, std::string assessments, std::string gender, std::string platform, std::string languages, std::string releaseDate);
