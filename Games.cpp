...
// Constructor
Games::Games(std::string name, std::string studio, std::string ageRating, float price, std::string availability, std::string assessments, std::string gender, std::string platform, std::string languages, std::string releaseDate) : 
    Products(name, studio, ageRating, price, availability, assessments), _gender(gender), _platform(platform), _languages(languages), _releaseDate(releaseDate)
{
